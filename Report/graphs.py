...
# Example data
# 14 values from 10000 to 148800
iterations = np.arange(10000, 148001, 10000)
...
y = [
    ...
    53.952, 51.160, 53.751, 55.172, 55.123
]
...
plt.ylabel("PQ")
plt.title("PQ vs Επαναλήψεις για Διαφορετικές Τιμές Επαναλήψεων Προσαρμογής της Θερμοκρασίας")
